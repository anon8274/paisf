...
common_parameters = {
    ...
    "traffic" : "trace_netrace_blackscholes-64",                            # CPU trace for blackscholes with 64 routers
        ...
        for routing_function in ["modular_routing","multi_routing"]:
            ...
            for mod_routing_function in mod_routing_functions:
                ...
                # It does not make sense to use hashed and adaptive_hashed because this would enforce in-order delivery twice
                    ...
                    hlp.print_error(f"Unknown routing function {routing_function} in experiment_cpu_trace.py")
                    sys.exit(1)
                # SELECTION FUNCTION
                for mod_selection_function in mod_selection_functions:
                    ...
                    exp['name'] = f"cpu_trace_{setting}_{topology}_{routing_function}_{mod_routing_function}_{mod_selection_function}"
